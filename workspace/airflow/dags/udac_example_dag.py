...
stage_events_to_redshift = StageToRedshiftOperator(
    ...
    s3_key="log_data/{execution_date.year}/{execution_date.month}", # S3 data source only has data for 2018/11, so only backfilling for that month will produce results
    source_format="json",
